...
public class mainForest {
	...
	public static void main(String[] args) throws Exception {
		...
		int forestNo = 15;     //number of decision trees in a forest
		int forestData = 1100; //number of instances each decision tree contains
		int forest=0;
		...
		for(i=0;i<16281;i++)
		{
			...
			if(Integer.parseInt(finalOut[i])==Integer.parseInt(test[i][14]) && Integer.parseInt(test[i][14])==1)
			{
				tp++;
			}
			if(Integer.parseInt(finalOut[i])!=Integer.parseInt(test[i][14]) && Integer.parseInt(test[i][14])==0)
			{
				fp++;
			}
			if(Integer.parseInt(finalOut[i])==Integer.parseInt(test[i][14]) && Integer.parseInt(test[i][14])==0)
